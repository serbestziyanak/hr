...
INSERT INTO `tb_birim_agaci` VALUES (279, 7, NULL, NULL, NULL, 'Ahmet Yesevi Meslek Yüksekokulu', 'ahmet-yesevi-meslek-yuksekokulu', 0, 0);
...
CREATE TABLE `tb_yetki_islem_turleri`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 58 CHARACTER SET = utf8 COLLATE = utf8_turkish_ci ROW_FORMAT = DYNAMIC;
