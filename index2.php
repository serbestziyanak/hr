                    ...
                    <div class="header-top">
                        ...
                        <div class="header-top-right">
                            <ul class="header-info">
                                ...
                                <li><a href="mailto:info@edublink.com" target="_blank"><i class="icon-envelope"></i>Email: info@ayu.edu.tr</a></li>
                                <li class="social-icon">
                                    <a href="https://facebook.com/AhmetYeseviUni" target="_blank"><i class="icon-facebook"></i></a>
                                    <a href="https://instagram.com/AhmetYeseviUni" target="_blank"><i class="icon-instagram"></i></a>
                                    <a href="https://twitter.com/AhmetYeseviUni" target="_blank"><i class="icon-twitter"></i></a>
                                    <a href="https://linkedin.com/AhmetYeseviUni" target="_blank"><i class="icon-linkedin2"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <ul class="mega-menu mega-menu-one">
                                            <li>
                                                <ul class="submenu mega-sub-menu mega-sub-menu-01">
                                                    <li><a href="index.php">EduBlink Education <span class="badge-1">hot</span></a></li>
