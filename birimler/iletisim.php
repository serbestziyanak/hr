...
==============================-->
    <div class="space" id="contact-sec">
        <div class="container">
            <div class="map-sec">
                <div class="map">
                    <iframe src="<?php echo $genel_ayarlar['map']; ?>" allowfullscreen="" loading="lazy"></iframe>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="me-xxl-5 mt-60">
                        ...
                        <div class="contact-feature">
                            ...
                            <div class="media-body">
                                ...
                                <?php echo $genel_ayarlar['adres'.$dil]; ?>
                            </div>
                        </div>
                        <div class="contact-feature">
                            <div class="contact-feature-icon">
                            ...
                            <div class="media-body">
                                ...
                                <a href="tel:<?php echo $genel_ayarlar['tel']; ?>" class="contact-feature_link">Phone: <span><?php echo $genel_ayarlar['tel']; ?></span></a>
                            </div>
                        </div>
                        <div class="contact-feature">
                            <div class="contact-feature-icon">
                            ...
                            <div class="media-body">
                                ...
                                <a href="mailto:<?php echo $genel_ayarlar['email']; ?>" class="contact-feature_link"><span><?php echo $genel_ayarlar['email']; ?></span></a>
                            </div>
                        </div>
                    </div>
                </div>
