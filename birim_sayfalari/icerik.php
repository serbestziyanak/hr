    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/2.jpg" data-overlay="title" data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title"><?php echo $birim_sayfa_bilgileri['adi']; ?></h1>
                <ul class="breadcumb-menu">
                    <li><a href="<?php echo $_REQUEST['kisa_ad']; ?>">Anasayfa</a></li>
                    <li><?php echo @$birim_sayfa_bilgileri['adi']; ?></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="th-blog blog-single" >
                        ...
                        <div class="blog-content" style="min-height: 600px;">
                            ...
                            <h2 class="blog-title"><?php echo @$birim_sayfa_icerikleri['baslik']; ?></h2>
                            <p>
                                <?php echo @$birim_sayfa_icerikleri['icerik']; ?>
                            </p>
                        </div>
                        <div class="share-links clearfix ">
                            <div class="row justify-content-between">
                                <div class="col-md-auto">
                                    ...
                                    <div class="tagcloud">
                                        <a href="<?php echo $birim_bilgileri['kisa_ad']; ?>"><?php echo @$birim_bilgileri['adi']; ?></a>
                                    </div>
                                </div>
                            ...
                            <div class="recent-post-wrap">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <h4 class="post-title" style="font-size: 12px;"><a class="text-inherit" href="blog-details.html"><?php echo $duyuru['baslik']; ?></a></h4>
